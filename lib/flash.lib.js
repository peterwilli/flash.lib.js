...
var Flash = function () {
  ...
  _createClass(Flash, [{
    ...
    value: function initialize(seed, depth, depositAmount, settlementAddress, securityLevel) {
      var state = {
        protocolVersion: _constants2.default.protocolVersion,
        pending: {
          addressesToCosign: {}
        },
        users: {},
      ...
      };state.pending.addressesToCosign[this.name] = (0, _state.generateAddressDigests)(this.iota, seed, depth + _constants2.default.reservedAddressSpace, 0, securityLevel);
    ...
    value: function join(seed, settlementAddress, securityLevel) {
      if (this.stateIsInitialized()) {
        ...
        if (Object.keys(this.state.pending.addressesToCosign).length > 0) {
          ...
          var addressesToCosign = (0, _state.generateAddressDigests)(this.iota, seed, this.state.publicLedger.depth + _constants2.default.reservedAddressSpace, 0, securityLevel);
